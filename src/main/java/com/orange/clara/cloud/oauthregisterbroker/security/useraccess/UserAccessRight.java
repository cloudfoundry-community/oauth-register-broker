...
public interface UserAccessRight {
    ...
    Boolean haveAccessToServiceInstance(OauthRegServiceInstanceBindings binding) throws UserAccessRightException;

    Boolean haveAccessToServiceInstance(OauthRegServiceInstance instance) throws UserAccessRightException;
}
